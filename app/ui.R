ui <- fluidPage(
  ...
  titlePanel("NFcriptomicsR: An R Shiny App to Analyze breast cancer cell line RNASeq data"),
  tabsetPanel(
    tabPanel("Home",
             mainPanel(
               h2("Welcome to NFcriptomicsR"),
               p("This is a Shiny App for analyzing RNA-Seq data of Neurofibroma. It comes with preloaded data, so no need to upload anything."),
